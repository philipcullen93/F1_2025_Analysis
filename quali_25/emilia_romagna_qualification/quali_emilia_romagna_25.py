...
session = fastf1.get_session(2025, 'Emilia-Romagna Grand Prix', 'Q')
session.load()
...
with open("fastest_laps_emilia_romagna_quali_25.txt", "w") as f:
...
plt.savefig("Emilia Romagna Qualifying Results.png", dpi=300)
plt.show()