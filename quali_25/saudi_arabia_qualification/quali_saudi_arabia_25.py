...
session = fastf1.get_session(2025, 'Saudi Arabia Grand Prix', 'Q')
session.load()
...
with open("fastest_laps_saudi_arabia_quali_25.txt", "w") as f:
...
plt.savefig("Saudi Arabia Qualifying Results.png", dpi=300)
plt.show()